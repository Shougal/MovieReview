...
class Database {
    ...
    public function dropTables() {
        ...
        $sequences = [
            ...
            "DROP SEQUENCE IF EXISTS reviews_final_seq CASCADE;"
        ];
    ...
    private function createSequences() {
        $sequences = [
            ...
            "CREATE SEQUENCE IF NOT EXISTS reviews_final_seq;"
        ];
    ...
    private function createTables() {
        $tables = [
            ...
            "CREATE TABLE IF NOT EXISTS reviews_final_spr3 (
                id INTEGER PRIMARY KEY DEFAULT nextval('reviews_final_seq'),
